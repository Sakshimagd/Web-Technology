...
//------Arrow function-------
console.log("Activity1 - Arrow function"); 
...
// fun("Anuja");
console.log("Activity2 - this keyword");
const user = {
    name : "sakshi",
    greet : function() {
...
// 5. Switch case in js
console.log("Activity5 - switch case");
let day = 3;
switch(day){
